...
//        curl_setopt($ch, CURLOPT_URL, "http://10.0.10.110/api/client/enregistrer");
        curl_setopt($ch, CURLOPT_URL, "http://10.0.10.110/journaux/public/api/client/enregistrer");
//        curl_setopt($ch, CURLOPT_URL, "http://10.0.10.110/api/client/enregistrer");
...
//        $url= "http://10.0.10.110/api/client/mesanciensabonnements/$id";
        $url= "http://10.0.10.110/journaux/public/api/client/mesanciensabonnements/$id";
        ...
        $url2= "http://10.0.10.110/journaux/public/api/magazine/lister";
...
//        $url= "http://10.0.10.110/api/client/mesabonnements/$id";
        $url= "http://10.0.10.110/journaux/public/api/client/mesabonnements/$id";
...
//        $url2= "http://10.0.10.110/journaux/public/api/magazine/lister";
    ...
    public function suspendreabonnement()
    {
        ...
        $ch = curl_init();
        $url = "http://10.0.10.110/journaux/public/api/client/suspendreabonnement";
//        $url = "http://10.0.10.110/journaux/public/api/client/suspendreabonnement";
        // configuration des options
...
//        dd($paye);
        ...
        $ch = curl_init();
//        $url = "http://10.0.10.110/journaux/public/api/client/renouvelerabonnement";
        $url = "http://10.0.10.110/journaux/public/api/client/renouvelerabonnement";
        // configuration des options
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_POST, true);
...
//dd($idAbonnement);
    ...
    public function relancerabonnementarrete()
    {
        ...
        $ch = curl_init();
//        $url = "http://10.0.10.110/journaux/public/api/client/relancerabonnementarrete";
        $url = "http://10.0.10.110/journaux/public/api/client/relancerabonnementarrete";
        // configuration des options
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_POST, true);
...
//dd($idAbonnement);
    ...
    public function sabonner()
    {
        ...
        $ch = curl_init();
//        $url = "http://10.0.10.110/journaux/public/api/client/sabonner";
        $url = "http://10.0.10.110/journaux/public/api/client/sabonner";
        // configuration des options
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_POST, true);
...
//        session()->set('success','Abonnement ajouté.');
    ...
    {
//        $url= "http://10.0.10.110/journaux/public/api/client/moncompte/$id";
        $url= "http://10.0.10.110/journaux/public/api/client/moncompte/$id";
    ...
    {
//        $url= "http://10.0.10.110/journaux/public/api/client/affichereditcompte/$id";
        $url= "http://10.0.10.110/journaux/public/api/client/affichereditcompte/$id";
    ...
    public function EditCompte()
    {
        ...
        $ch = curl_init();
//        $url = "http://10.0.10.110/journaux/public/api/client/edit";
        $url = "http://10.0.10.110/journaux/public/api/client/edit";
        // configuration des options
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_POST, true);
